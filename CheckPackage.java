...
public class CheckPackage extends JFrame {
    ...
    CheckPackage(String Username) {    
        ...
        String[] package1 = new String[]{
            ...
            "Airport Assistance at Airport", "Half Day City Tour", 
        ...
        String[] package2 = new String[]{
            ...
            "BOOK NOW", "Winter Special", "Rs 25000 only"
        };
        String[] package3 = new String[]{
            ...
            "Welcome drinks on Arrival", "Daily Buffet", 
            "Stay in 5 Star Hotel", "BBQ Dinner", 
            "BOOK NOW", "Winter Special", "Rs 32000 only"
        };
    ...
    public JPanel createPackage(String[] pack) {
        ...
        lblCheckInStatus.setBounds(35, 360, 200, 30);
        p1.add(lblCheckInStatus);

        JLabel lblDeposite = new JLabel(pack[10]);
        lblDeposite.setFont(new Font("Yu Mincho", Font.PLAIN, 25));
        lblDeposite.setBounds(35, 420, 400, 40);
        p1.add(lblDeposite);
        
        JLabel la1 = new JLabel(pack[11]);
        la1.setForeground(Color.RED);
        la1.setFont(new Font("Yu Mincho", Font.BOLD, 28));
