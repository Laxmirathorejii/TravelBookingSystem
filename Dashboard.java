...
public class Dashboard extends JFrame implements ActionListener {
    ...
    String username;
    JButton  addPersonalDetails,viewPersonalDetails, updatePersonalDetails,checkpackage,bookpackage, viewhotels,destinations,bookhotel,viewbookedhotel,payments,
         calculators,notepad,about, deletePersonalDetails;
    Dashboard(String username)
    {
        ...
        updatePersonalDetails.setMargin(new Insets(0,0,0,70));
        
        p2.add(updatePersonalDetails);
        
         viewPersonalDetails = new JButton("View Personal Deatils");
